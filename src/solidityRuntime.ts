...
/**
 * A solidity runtime with some debugger functionality.
 */
export class SolidityRuntime extends EventEmitter {
	...
	// maps from sourceFile to array of solidity breakpoints
	 ...
	 */
	public start(program: string, stopOnEntry: boolean, compiledJson: string, rpc: string, transactionHash: string) {
