...
/**
 * This interface describes the solidity-debug specific launch attributes
 * (which are not part of the Debug Adapter Protocol).
 * The schema for these attributes lives in the package.json of the solidity-debug extension.
...
interface LaunchRequestArguments extends DebugProtocol.LaunchRequestArguments {
	...
	trace?: boolean;
	/** Path to file with compiled JSON (build/contracts/*.json in case of Truffle) */
	compiledJson: string;
	/** Ethereum RPC HTTP Provider, typically http://localhost:8545/ (debug must be enabled in RPC) */
	rpc: string;
	/** Transaction Hash to be debugged*/
...
class SolidityDebugSession extends LoggingDebugSession {
	...
	// a Solidity runtime (or debugger)
	...
	protected launchRequest(response: DebugProtocol.LaunchResponse, args: LaunchRequestArguments): void {
		...
		this._runtime.start(args.program, !!args.stopOnEntry, args.compiledJson, args.rpc, args.transactionHash);
